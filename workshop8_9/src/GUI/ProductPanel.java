...
//        return false;
//    }
    public static void setModelComboBox() {
        Vector<Product> list2 = DAO.ProductDAO.getfullSypplierName();
        Vector<String> s = new Vector<>();
//        DefaultComboBoxModel model2 = (DefaultComboBoxModel) cbxSuplierName.getModel();
        for (Product product : list2) {
//            if(checkProductName(product.getSupplier())){
            s.addElement(product.getSupplier());
//            }
        }
        DefaultComboBoxModel model2 = new DefaultComboBoxModel(s);
        cbxSuplierName.setModel(model2);
        cbxSuplierName.updateUI();
...
//        cbxSuplierName.setModel(model2);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SEARCH SUPLIER ID");
    ...
    private Vector<Product> findName(String name) {
        ...
        for (Product pr : list) {
            if (pr.getIdSupplier().toUpperCase().contains(name.toUpperCase())) {
                list2.add(pr);
            }
        }
...
//        cbxSuplierName.setSelectedIndex(0);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String supplierId = (String) jTable1.getValueAt(pos, 3);
...
//            }
    ...
    public static javax.swing.JComboBox<String> cbxSuplierName;
